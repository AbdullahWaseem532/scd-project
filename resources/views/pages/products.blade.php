...
@section('description', 'Browse our complete collection of premium eBooks and digital courses across multiple categories.')
                ...
                <div class="products-main">
                    ...
                    <div class="products-toolbar">
                        <div class="toolbar-left">
                            <p class="results-count">Showing {{ count($products) }} of {{ $totalProducts }} courses</p>
                        </div>
                    </div>
