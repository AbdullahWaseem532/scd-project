            ...
            <div class="product-hero-layout">
                ...
                <div class="product-hero-content">
                    ...
                    <div class="product-meta-bar">
                        <div class="meta-item">
                            ...
                            <a href="#" class="meta-value instructor-link">{{ $product['author'] }}</a>
                        </div>
                        <div class="meta-item">
                            <div class="rating-display">
                                ...
                                <span class="rating-count">({{ number_format($product['reviews']) }} reviews)</span>
                            </div>
                        </div>
                        <div class="meta-item">
                            <i class="fas fa-user-graduate"></i>
                            <span class="meta-value">{{ number_format($product['students']) }} students</span>
                        </div>
                        <div class="meta-item">
                        ...
                        <div class="meta-item">
                            ...
                            <span class="meta-value">{{ $product['language'] }}</span>
                        </div>
                        <div class="meta-item">
                ...
                <div class="product-preview-card desktop-only">
                    ...
                    <div class="preview-content">
                        ...
                        @if(isset($product['discount_expires']))
                            <div class="discount-timer">
                                <i class="fas fa-clock"></i>
                                <span class="timer-text">{{ $product['discount_expires'] }} left at this price!</span>
                            </div>
                        @endif
                        ...
                        <div class="includes-section">
                            ...
                            <ul class="includes-list">
                                <li><i class="fas fa-video"></i> {{ $product['video_hours'] }} hours on-demand video</li>
                                <li><i class="fas fa-file-alt"></i> {{ $product['articles'] }} articles</li>
                                <li><i class="fas fa-download"></i> {{ $product['resources'] }} downloadable resources</li>
                ...
                <div class="product-main-content">
                    ...
                    <div class="content-card">
                        ...
                        <div class="learning-objectives">
                            @foreach($product['learning_objectives'] as $objective)
                    ...
                    <div class="content-card">
                        ...
                        <div class="course-stats">
                            <span>{{ $product['sections'] }} sections</span>
                            <span>•</span>
                            <span>{{ $product['lectures'] }} lectures</span>
                            <span>•</span>
                            <span>{{ $product['duration'] }} total length</span>
                        </div>
                        <div class="curriculum">
                            @foreach($product['curriculum'] as $index => $section)
                                <div class="curriculum-section">
                                    <div class="section-header-prod" onclick="toggleSection({{ $index }})">
                        ...
                        <div class="instructor-card">
                            <div class="instructor-header">
                                <div class="instructor-avatar">
                                    {{ substr($product['author'], 0, 1) }}
                                </div>
                                <div class="instructor-info">
                                    <h3 class="instructor-name">{{ $product['author'] }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content-card">
                        ...
                        <div class="feedback-summary">
                            <div class="rating-overview">
                                <div class="rating-number-large">{{ $product['rating'] }}</div>
                    ...
                    <div class="content-card">
                        ...
                        <div class="reviews-list">
                            @foreach($product['reviewsDetailed'] as $review)
