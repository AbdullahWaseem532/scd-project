...
@section('title', 'About Us - CourseHub')
@section('description', 'Learn about CourseHub\'s mission to provide quality education and empower learners worldwide.')
...
<section class="cta-section">
    <div class="container">
        <div class="cta-content">
            ...
            <a href="{{ route('products') }}" class="btn btn-light btn-lg">Explore Courses</a>
        </div>
    </div>
</section>
@endsection