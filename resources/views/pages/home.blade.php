...
@section('title', 'CourseHub - Premium eBooks & Digital Courses')
@section('description', 'Discover thousands of premium eBooks and digital courses to advance your skills and knowledge.')
            ...
            <div class="hero-content">
                <div class="hero-text">
                    ...
                    <div class="hero-actions">
                        <a href="{{ route('products') }}" class="btn btn-primary btn-lg">Explore Courses</a>
    ...
    <section class="featured-products">
        <div class="container">
            ...
            <div class="section-action">
                <a href="{{ route('products') }}" class="btn btn-secondary">View All Courses</a>
            </div>
        </div>
    </section>
    ...
    <section class="cta-section">
        <div class="container">
            <div class="cta-content">
                ...
                <a href="{{ route('products') }}" class="btn btn-light btn-lg">Get Started Today</a>
            </div>
        </div>
    </section>
@endsection